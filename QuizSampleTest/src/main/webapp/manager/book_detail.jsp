<%@page import="bitedu.bipa.member.utils.DateCalculation"%>
	...
	<script type="text/javascript">
		$(document).ready(function(){
			$('#go_view_update').on('click',function(){
				...
				$('#frm').attr('action',"./BlmController?cmd=view_update&bookSeq="+bookSeqVal);
				$('#frm').submit();
			});
		});
...
<body>
<% BookCopy copy = (BookCopy)request.getAttribute("list"); %>
